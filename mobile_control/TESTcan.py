...
a = ubyte_array(0x2f, 0x60, 0x60, 0x00, 0x03)

ubyte_3array = c_ubyte*3
b = ubyte_3array(0, 0 , 0)
vci_can_obj_4 = VCI_CAN_OBJ(0x00000604, 0, 0, 0, 0, 0,  8, a, b)
...
#使能
ubyte_array = c_ubyte*8
a = ubyte_array(0x2b, 0x40, 0x60, 0x00, 0x06, 0x00)
...
ubyte_array = c_ubyte*8
a = ubyte_array(0x2b, 0x40, 0x60, 0x00, 0x07, 0x00)
...
ubyte_array = c_ubyte*8
a = ubyte_array(0x2b, 0x40, 0x60, 0x00, 0x0f, 0x00)
...
# 发送速度指令
ubyte_array = c_ubyte*8
a = ubyte_array(0x23, 0xff, 0x60, 0x00, 0xc8, 0x00, 0x00, 0x00)
...
while 1:
    if ret > 0:
        seret = canDLL.VCI_Transmit(VCI_USBCAN2A, 0, 0, byref(vci_can_obj_4), 1)
        print("i send data 1",seret)
