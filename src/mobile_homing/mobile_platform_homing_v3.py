                ...
                if flag_1==1 and mpfh.Abs_Encoder_fr_id2_oct!=0 and mpfh.Abs_Encoder_fl_id1_oct!=0 and mpfh.Abs_Encoder_rr_id4_oct!=0 and mpfh.Abs_Encoder_rl_id3_oct!=0:
                    ...
                    if flg_fl=='fl':
                        ...
                        if mpfh.Pid.SetPoint > 0:
                            feedback_fl =(mpfh.Abs_Encoder_fl_id1_oct*50)/1024# (output - (1/i))控制系统的函数
                            print "Feedback",feedback_fl
                        if i>1:
                            mpfh.Pid.SetPoint = (mpfh.fl_abs_encode*50)/1024
                            print "(mpfh.rl_abs_encode*50)/1024",mpfh.Pid.SetPoint,(mpfh.fl_abs_encode*50)/1024
                    ...
                    if flg_fr=='fr':
                        ...
                        output = mpfh.Pid.output
                        print "output-------fr",output
                        if mpfh.Pid.SetPoint > 0:
                            feedback_fr =(mpfh.Abs_Encoder_fr_id2_oct*50)/1024# (output - (1/i))控制系统的函数
                            print "Feedback--------fr",feedback_fr
                        if i>1:
                            mpfh.Pid.SetPoint = (mpfh.fr_abs_encode*50)/1024
                            print "(mpfh.fr_abs_encode*50)/1024",mpfh.Pid.SetPoint,(mpfh.fr_abs_encode*50)/1024
                        mpfh.MobileControl.Send_Velocity_Driver(output,'right',mpfh.MobileControl.CanAnalysis.yamlDic['steering_channel']['chn1'])
                    ...
                    if flg_rl=='rl':
                        ...
                        output = mpfh.Pid.output
                        print "rl-----output----rl",output
                        if mpfh.Pid.SetPoint > 0:
                            feedback_rl =(mpfh.Abs_Encoder_rl_id3_oct*50)/1024# (output - (1/i))控制系统的函数
                            print "Feedback--------rl",feedback_rl
                        if i>1:
                            mpfh.Pid.SetPoint = (mpfh.rl_abs_encode*50)/1024
                            print "(mpfh.rl_abs_encode*50)/1024",mpfh.Pid.SetPoint,(mpfh.rl_abs_encode*50)/1024
                    ...
                    if flg_rr=='rr':
                        ...
                        if mpfh.Pid.SetPoint > 0:
                            feedback_rr =(mpfh.Abs_Encoder_rr_id4_oct*50)/1024# (output - (1/i))控制系统的函数
                            print "Feedback--------rr",feedback_rr
                        if i>1:
                            mpfh.Pid.SetPoint = (mpfh.rr_abs_encode*50)/1024
                            print "(mpfh.rr_abs_encode*50)/1024",mpfh.Pid.SetPoint,(mpfh.rr_abs_encode*50)/1024
                        mpfh.MobileControl.Send_Velocity_Driver(output,'right',mpfh.MobileControl.CanAnalysis.yamlDic['steering_channel']['chn2'])
                        time.sleep(0.01)
